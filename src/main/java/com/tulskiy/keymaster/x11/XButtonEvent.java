 ...
 */
@Library("test") 
public class XButtonEvent extends StructObject {
	public XButtonEvent() {
		super();
	}
	public XButtonEvent(Pointer pointer) {
		super(pointer);
	}
	/// of event
	@Field(0) 
	...
	/// of event
	@Field(0) 
	public XButtonEvent type(int type) {
	...
	@CLong 
	@Field(1) 
	public XButtonEvent serial(long serial) {
	...
	/// true if this came from a SendEvent request
	@Field(2) 
	public XButtonEvent send_event(int send_event) {
	 ...
	 */
	@Field(3) 
	public XButtonEvent display(Pointer<LibX11.XDisplay> display) {
	...
	@CLong 
	@Field(4) 
	public XButtonEvent window(long window) {
	...
	@CLong 
	@Field(5) 
	public XButtonEvent root(long root) {
	...
	@CLong 
	@Field(6) 
	public XButtonEvent subwindow(long subwindow) {
	...
	@CLong 
	@Field(7) 
	public XButtonEvent time(long time) {
	...
	/// coordinates relative to root
	@Field(10) 
	public XButtonEvent x_root(int x_root) {
	...
	/// coordinates relative to root
	@Field(11) 
	public XButtonEvent y_root(int y_root) {
	...
	/// key or button mask
	@Field(12) 
	public XButtonEvent state(int state) {
	...
	/// detail
	@Field(13) 
	public XButtonEvent button(int button) {
		this.io.setIntField(this, 13, button);
		return this;
	}
	/// same screen flag
	@Field(14) 
	...
	/// same screen flag
	@Field(14) 
	public XButtonEvent same_screen(int same_screen) {
